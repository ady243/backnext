...
const RichText = (props) => {
    const { path: pathFromProps, name, required, validate = richText, label, admin, admin: { readOnly, style, className, width, placeholder, description, hideGutter, condition, } = {}, } = props;
    ...
    const renderLeaf = useCallback(({ attributes, children, leaf }) => {
        ...
        if ((_a = enabledLeaves[matchedLeafName]) === null || _a === void 0 ? void 0 : _a.Leaf) {
            ...
            return (React.createElement(Leaf, { attributes: attributes, leaf: leaf, path: path, fieldProps: props, editorRef: editorRef }, children));
        }
            ...
            React.createElement(Slate, { editor: editor, value: valueToRender, onChange: (val) => {
                ...
                React.createElement("div", { className: `${baseClass}__wrapper` },
                    ...
                    React.createElement("div", { className: `${baseClass}__editor`, ref: editorRef },
                        React.createElement(Editable, { className: `${baseClass}__input`, renderElement: renderElement, renderLeaf: renderLeaf, placeholder: placeholder, spellCheck: true, readOnly: readOnly, onBlur: onBlur, onKeyDown: (event) => {
                                if (event.key === 'Enter') {
                                    if (event.shiftKey) {
